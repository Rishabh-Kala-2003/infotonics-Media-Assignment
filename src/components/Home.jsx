...
import 'simple-datatables/dist/style.css'; // Importing the default styles for simple-datatables
import '@popperjs/core/dist/umd/popper.min.js'; // Importing popper.js for Bootstrap's dropdowns and tooltips
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body"><AreaChart width="100%" height="40"/></div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">< BarChart width="100%" height="40"/></div>
                                </div>
                            </div>
                        </div>
                        <div class="card mb-4">
